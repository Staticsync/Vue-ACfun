<template lang="html">
	<div class="wrap">
		<div class="head">
			...
			<div class="searchbox">
				<input type="search" autofocus @keypress.enter="search(keywords)" v-model="keywords" placeholder="输入关键词或AC号">
			</div>
			<div class="searchbtn">
				<button class="icon-search" @click="search(keywords)"
        style="border:none;font-size:30px;color:#000;background-color: #F8565F;outline-style: none;"
        ></button>
			</div>
		</div>
		...
		<div class="noresultwrap" v-else>
			<p class="noresult">没找到你要的内容，看看下面这些吧</p>
